                            ...
                            <?php
                                ...
                                <!-- <li class="exclusive">
                                    <ul class="pricing-wrapper">
                                        <li data-type="monthly" class="is-visible">
                                            <header class="pricing-header">
                                                <h2 style="font-size:42px; color:#F55020;">Viral vision</h2>
                                                <div class="price">
                                                    <span class="currency">₹</span>
                                            ...
                                            <div class="pricing-body">
                                                <ul class="pricing-features">
                                                    <li><em>50</em> Big Pages ✅</li>
                                                    <li><em>50</em> Micro Pages ✅ </li>
                                ...
                                <li>
                                    <ul class="pricing-wrapper">
                                        <li data-type="monthly" class="is-visible">
                                            <header class="pricing-header">
                                                <h2 style="font-size:42px;">Trending Assured</h2>
                                                <div class="price">
                                                    <span class="currency">₹</span>
                                            ...
                                            <div class="pricing-body">
                                                <ul class="pricing-features">
                                                    <li><em>200</em> Big Pages ✅</li>
                                                    <li><em>200</em> Micro Pages ✅ </li>
                                                    <li><em>High </em> Reach ✅ </li>
                                                    <li><em>Possibilities of trending</em> ✅</li>
                                                    <li><em>Reels + story promotion <br><br> from all the pages ✅</em></li>
                                                </ul>
