                ...
                <div class="container">
                    ...
                    <div class="project" id="client">
                        ...
                        <div class="pricing-container">
                            ...
                            <?php
                                    $query = mysqli_query($conn, "select * from music_distribution where is_active=1 order by music_distribution_id asc ");
                                    ...
                                    <ul class="pricing-wrapper">
                                        <li data-type="monthly" class="is-visible">
                                            <header class="pricing-header">
                                                <h2 style="font-size:42px;"><?=$row['music_distribution_name']?></h2>
                                                <div class="price">
                                                    <span class="currency">₹</span>
                                                    <span class="value"><?=$row['music_distribution_price']?></span>
                                                    <span class="duration"></span>
                                                </div>
                                            </header>
                                            <div class="pricing-body">
                                                <ul class="pricing-features">
                                                    <li><em><?=$row['music_distribution_desc']?></em> </li>
                                                </ul>
                                            </div>
