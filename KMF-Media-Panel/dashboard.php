						...
						<div class="container">
							...
							<div class="row py-5">
								<div class="col-12 text-center">
									<h1 style="font-size:3rem;">Welcome to KMF Media Panel</h1>
									<h4>Manage <span style="color:brown;">Everything</span> here.</h4>
									<hr>
								</div>
							</div>
							...
							<div class="row my-3">
								...
								<div class="col-12 col-lg-6 text-center">
									<img src="<?= BASE_URL ?>images/nidmm2.jpg" alt="" width="100%" style="box-shadow:0px 25px 40px grey;">
								</div>
									...
									<table class="table table-bordered">
										<thead>
											<tr>
												...
												<th scope="col">KMF Media</th>
											</tr>
										</thead>
										<tbody>
											<tr>
												<th scope="row">CEO</th>
												<td>Saurabh Kumar Yadav</td>
											...
											<tr>
												<th scope="row">Market Cover</th>
												<td>India</td>

											</tr>
											<tr>
												<th scope="row">Type of</th>
												<td colspan="2">Music Distribution &amp; Promotions</td>
											</tr>
										</tbody>
									</table>

									<p>
									Kmf Media takes your music to your Target audience! - Constructing the perfect marketing strategy to bridge the gap between you and your target.
									</p>
							...
							<div class="row">
								<div class="col-12 text-right">
									<a href="https://globaltradebazaar.com/"><img src="<?= BASE_URL ?>images/nidmm.png" alt="" class="img-fluid" width="30%"></a>
								</div>
							</div>
							<!--end::Row-->
