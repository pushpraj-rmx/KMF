...
if (isset($_POST['update_slider'])) {
	...
	$query = mysqli_query($conn, "update blog
    	                                             SET blog_title='$blog_title',
													 blog_content='$blog_content',
													 main_page_desc='$main_page_desc',
													 blog_img='$blog_img',
    	                                             is_active=$is_active where blog_id=$edit_id");
...
$details = mysqli_fetch_array(mysqli_query($conn, "select * from blog where blog_id=$edit_id"));
?>
<!--begin::Body-->
