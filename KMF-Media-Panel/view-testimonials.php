...
$details = mysqli_fetch_array(mysqli_query($conn, "select * from tbl_outdoor_equipment where outdoor_id=$view_id"));
?>
<!--begin::Body-->
							...
							<div class="card card-custom gutter-b">
								...
								<div class="card-body">
									...
									<div class=" card-custom gutter-b example example-compact">
										...
										<!--begin::Form-->
										<form action="" enctype="multipart/form-data" method="post" id="add-slider">
											<div class="card-body">
												<table id="example" class="table table-bordered  dataTable " style="width:100%">
													...
													<tbody>
														<tr>
															<td>Image</td>
															<td><img src="<?= BASE_URL_IMG ?>home-use/<?= $details['outdoor_img'] ?>" width='150'></td>
														</tr>
														<tr>
															<td>Heading</td>
															<td><?= $details['outdoor_name'] ?></td>
														</tr>
														<tr>
															<td>Status</td>
