...
if (isset($_POST['update_slider'])) {
	...
	$query = mysqli_query($conn, "update youtube_link
    	                                             SET youtube_link='$youtube_link',
    	                                             is_active=$is_active where youtube_link_id=$edit_id");

	if ($query) {
		header('Location:manage-youtube-link.php');
	}
}
$details = mysqli_fetch_array(mysqli_query($conn, "select * from youtube_link where youtube_link_id=$edit_id"));
?>
<!--begin::Body-->
										...
										<form action="" enctype="multipart/form-data" method="post" id="edit-slider">
											<div class="card-body">
												...
												<div class="form-group">
													<label for="exampleInputPassword1">YouTube Link
														<span class="text-danger">*</span></label>
													<input type="text" name="youtube_link" value="<?= $details['youtube_link'] ?>" class="form-control" autocomplete="off" placeholder="Heading">
												</div>
