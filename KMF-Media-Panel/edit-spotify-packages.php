...
if (isset($_POST['update_slider'])) {
	...
	$query = mysqli_query($conn, "update spotify_package
    	                                             SET package_name='$package_name',
													 package_price='$package_price',
													 package_desc='$package_desc',
    	                                             is_active=$is_active where spackage_id=$edit_id");

	if ($query) {
		header('Location:manage-spotify-packages.php');
	}
}
$details = mysqli_fetch_array(mysqli_query($conn, "select * from spotify_package where spackage_id=$edit_id"));
?>
<!--begin::Body-->
					...
					<div class="subheader py-2 py-lg-4 subheader-solid" id="kt_subheader">
						<div class="container-fluid d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
							...
							<div class="d-flex align-items-center flex-wrap mr-2">
								<!--begin::Page Title-->
								<h5 class="text-dark font-weight-bold mt-2 mb-2 mr-5">Edit Spotify Package</h5>
								<!--end::Page Title-->
							...
							<div class="card card-custom gutter-b">
								<div class="card-header flex-wrap py-3">
									...
									<div class="card-toolbar">
										<!--begin::Button-->
										<a href="<?= BASE_URL ?>manage-spotify-packages.php" class="btn btn-primary font-weight-bolder">
