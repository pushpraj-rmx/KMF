					...
					<div class="subheader py-2 py-lg-4 subheader-solid" id="kt_subheader">
						<div class="container-fluid d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
							...
							<div class="d-flex align-items-center flex-wrap mr-2">
								<!--begin::Page Title-->
								<h5 class="text-dark font-weight-bold mt-2 mb-2 mr-5">Add New Testimonial</h5>
								<!--end::Page Title-->
							</div>
							<!--end::Info-->
							...
							<div class="card card-custom gutter-b">
								<div class="card-header flex-wrap py-3">
									...
									<div class="card-toolbar">
										<!--begin::Button-->
										<a href="<?= BASE_URL ?>manage-testimonials.php" class="btn btn-primary font-weight-bolder">
										...
										<form method="post" enctype="multipart/form-data">
											<div class="card-body">
												<div class="form-group">
													...
													<input type="text" name="testimonials_name" value="" class="form-control" autocomplete="off" placeholder="Name">
												</div>
												<div class="form-group">
													<label for="exampleInputPassword1"> Testimonial
														<span class="text-danger">*</span></label>
													<input type="text" name="testimonials_quote" value="" class="form-control" autocomplete="off" placeholder="Name">
												</div>
