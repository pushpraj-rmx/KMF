            ...
            <div class="project-detail">
                <div class="container">
                    ...
                    <div class="project" id="client">
                        <span class="whats-app" id="whatsapp-message">
                            <h2>Spotify Promotions</h2>
                        </span>
                        <p class="lead">
                                ...
                                <ul class="pricing-list bounce-invert">
                                        ...
                                        <ul class="pricing-wrapper">
                                            <li data-type="monthly" class="is-visible">
                                                ...
                                                <div class="pricing-body">
                                                    <ul class="pricing-features">
                                                        <li><em>(GLOBAL)</em> </li>
                                                        <li><em>100,000+</em> Streams ✅</li>
                                                        <li><em>10k+</em> Monthly listeners ✅ </li>
                                                        <li><em>(INDIAN)</em> </li>
                                                        <li class="special-style"><em> <span class="currency">₹</span>20,000 </em></li>
                                                        <li><em>100,000+</em> Streams ✅</li>
                                                        <li><em>15k+</em> Monthly listeners ✅</li>
                                                    </ul>
                                                </div>
                                                <style>
                                                    .special-style em {
                                    ...
                                    <!-- <li>
                                        <ul class="pricing-wrapper">
                                            <li data-type="monthly" class="is-visible">
                                                <header class="pricing-header">
                                                    <h2 style="font-size:42px;">Playlist Magic</h2>
                                                    <div class="price">
                                                        <span class="currency">₹</span>
                                                ...
                                                <div class="pricing-body">
                                                    <ul class="pricing-features">
                                                        <li><em>
                                                                Get your songs listed <br><br>in genre/category <br><br>specific curated playlists.</em> </li>
                                                        <li><em>We have playlists for<br><br> every Genre of Music.</em></li>
                                                    </ul>
                                                </div>
                                                <footer class="pricing-footer">
                                                    <a class="select" href="contact-us.php">Book Now</a>
                            ...
                            <style>
                                @media only screen and (max-width: 767px) {
                                    .project-detail .project h2 {
                                        font-size: 61px;
                                        /* Adjust this size according to your preference for smaller screens */
                                    }
